              ...
              <li key={ page } className="page-item">
                <Link
                  className={clsx(
                    ...
                    {
                      'page-link relative block py-1.5 px-3 rounded border-0 bg-blue-600 outline-none transition-all duration-300 text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md': page === currentPage
                    }
